	class Producto {
		...
		constructor(n, s, p, d = true){//<-- En el caso de que disponible sea "undefined x el usuario" lo lee como un TRUE a menos que se especifique lo contrario.
		//Atributos
		this.nombre = n
		this.stock = s
		this.precio = p
		...
		static parse(json){ //
			...
			if(datos instanceof Array){
				...
				datos.forEach( item => {
					...
					//4)G Guardar el objeto Producto instanciado en el Array nuevo
